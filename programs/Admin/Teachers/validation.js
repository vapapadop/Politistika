    ...
    switch (requirement)
    {
      ...
      case "digits_only":       
        ...
        break;
         ...
         case "dig_only":       
        if (form[fieldName].value && !form[fieldName].value.match(/\5.3/))
        {
          alertMessage(form[fieldName], errorMessage);
          return false;
        }
      ...
      case "letters_only": 
        if (form[fieldName].value && !form[fieldName].value.match(/^[Α-Ω]/))
        {
          alertMessage(form[fieldName], errorMessage);
          return false;
        }
        break;
		 ...
		 case "letters": 
        if (form[fieldName].value && !form[fieldName].value.match(/^[Α-Ωα-ω]/))
        {
          alertMessage(form[fieldName], errorMessage);
          return false;
        }
...
function alertMessage(obj, message)
{
  ...
  {
    obj.style.background = g_backgroundColor;
    obj.focus();
  }
  return false;
}
