...
$cLoginTable = "pschools";
$cDisplayNameField = "sch_name";
$cUserNameField	= "username";
$cPasswordField	= "password";
$cUserGroupField = "sch_code";
$cEmailField = "email";
...
$tableCaptions["English"]["ft_form_4"] = "Πίνακας Αιτήσεων-ΟΛΕΣ";
$tableCaptions["English"]["pschools"] = "Στοιχεία Σχολείων";
$tableCaptions["English"]["settings"] = "Ρυθμίσεις Εφαρμογής";
$tableCaptions["English"]["FINAL_SUBMITED"] = "ΜΟΝΟ ΟΡΙΣΤΙΚΕΣ ΥΠΟΒΟΛΕΣ";
$tableCaptions["English"]["FINAL_STOPED"] = "ΟΡΙΣΤΙΚΕΣ ΜΕ ΔΙΑΚΟΠΗ";
$tableCaptions["English"]["prosorines"] = "ΜΟΝΟ ΠΡΟΣΩΡΙΝΕΣ ΥΠΟΒΟΛΕΣ";
