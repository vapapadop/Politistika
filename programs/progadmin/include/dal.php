...
class tDAL
{
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
	  $this->lstTables[]=array("name"=>"ft_form_4","varname"=>"ft_form_4");
	  $this->lstTables[]=array("name"=>"pschools","varname"=>"pschools");
	  $this->lstTables[]=array("name"=>"settings","varname"=>"settings");
	}
