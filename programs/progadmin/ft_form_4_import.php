...
// keys array
$keys[]=AddFieldWrappers("submission_id");
$keys_present=1;
...
function ImportFromExcel($uploadfile)
{
	...
	for($k=0; $k<count($keys); $k++)
	{
		...
		if(in_array("submission_id",$fields))
		$autoinc=true;
...
$layout->blocks["top"][] = "import";$page_layouts["ft_form_4_import"] = $layout;
...
$xt->display("ft_form_4_import.htm");
