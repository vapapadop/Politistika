...
$layout->blocks["top"][] = "export";$page_layouts["pschools_export"] = $layout;
...
$xt->display("pschools_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=pschools.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=pschools.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=pschools.xml");
	...
	while((!$nPageSize || $i<$nPageSize) && $row)
	{
		$values = array();
			...
			$values["sch_code"] = $pageObject->showDBValue("sch_code", $row);
			$values["sch_perioxi"] = $pageObject->showDBValue("sch_perioxi", $row);
			$values["sch_name"] = $pageObject->showDBValue("sch_name", $row);
			$values["sch_dimos"] = $pageObject->showDBValue("sch_dimos", $row);
			$values["sch_phone"] = $pageObject->showDBValue("sch_phone", $row);
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=pschools.csv");
...
// write data rows
	...
	while((!$nPageSize || $iNumberOfRows < $nPageSize) && $row)
	{
		$values = array();
			...
			$values["sch_code"] = $pageObject->getViewControl("sch_code")->showDBValue($row, "");
			$values["sch_perioxi"] = $pageObject->getViewControl("sch_perioxi")->showDBValue($row, "");
			$values["sch_name"] = $pageObject->getViewControl("sch_name")->showDBValue($row, "");
			$values["sch_dimos"] = $pageObject->getViewControl("sch_dimos")->showDBValue($row, "");
			$values["sch_phone"] = $pageObject->getViewControl("sch_phone")->showDBValue($row, "");
		...
		if ($eventRes)
		{
			...
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["sch_code"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["sch_perioxi"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["sch_name"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["sch_dimos"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["sch_phone"]).'"';
			if($outstr!="")
				$outstr.=",";
...
// write header
	...
	{
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Sch Id").'</td>';	
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Sch Code").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Sch Perioxi").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Sch Name").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Sch Dimos").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Sch Phone").'</td>';	
	...
	else
	{
		...
		echo "<td>"."Password"."</td>";
		echo "<td>"."Sch Code"."</td>";
		echo "<td>"."Sch Perioxi"."</td>";
		echo "<td>"."Sch Name"."</td>";
		echo "<td>"."Sch Dimos"."</td>";
		echo "<td>"."Sch Phone"."</td>";
		echo "<td>"."Fax"."</td>";
		echo "<td>"."Email"."</td>";
	}
	echo "</tr>";
		...
		if ($eventRes)
		{
			...
			echo '</td>';
					...
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["sch_code"]);
					else
						echo $values["sch_code"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["sch_perioxi"]);
					else
						echo $values["sch_perioxi"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
			...
			echo '</td>';
					...
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["sch_dimos"]);
					else
						echo $values["sch_dimos"];
			echo '</td>';
							echo '<td>';
			
									echo $values["sch_phone"];
			echo '</td>';
							echo '<td>';
