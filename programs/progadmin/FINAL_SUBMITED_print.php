...
$layout->blocks["top"][] = "pdf";$page_layouts["FINAL_SUBMITED_print"] = $layout;
...
//	sch_id1 - 
			$record["sch_id1_value"] = $pageObject->showDBValue("sch_id1", $data, $keylink);
			$record["sch_id1_class"] = $pageObject->fieldClass("sch_id1");
//	submission_id - 
...
$xt->assign("sch_id1_fieldheadercolumn",true);
$xt->assign("sch_id1_fieldheader",true);
$xt->assign("sch_id1_fieldcolumn",true);
$xt->assign("sch_id1_fieldfootercolumn",true);
