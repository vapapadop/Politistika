...
function GetTableURL($table = "")
{
	...
	if("settings" == $table) 
		return "settings";
	if("FINAL SUBMITED" == $table) 
		return "FINAL_SUBMITED";
	if("FINAL_STOPED" == $table) 
		return "FINAL_STOPED";
	if("prosorines" == $table) 
		return "prosorines";
}
...
{	
	...
	if(!$shortTName)
		return false;
	if("ft_form_4" == $shortTName) 
		return "ft_form_4";
	if("pschools" == $shortTName) 
		return "pschools";
	if("settings" == $shortTName) 
		return "settings";
	if("FINAL_SUBMITED" == $shortTName) 
		return "FINAL SUBMITED";
	if("FINAL_STOPED" == $shortTName) 
		return "FINAL_STOPED";
	if("prosorines" == $shortTName) 
		return "prosorines";
}
