...
$layout->blocks["top"][] = "details";$page_layouts["ft_form_4_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='ft_form_4_edit.php?".$editlink."'\"");
