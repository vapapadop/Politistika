<?php
// $Header: /cvsrepos/html2ps/config.inc.php,v 1.1 2008/07/01 12:30:23 sergey Exp $
...
$path=substr($path,0,strlen($path)-15)."templates_c";
define('OUTPUT_FILE_DIRECTORY', $path."/");
